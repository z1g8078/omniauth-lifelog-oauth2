...
module OmniAuth
  module Strategies
    class LifelogOauth2 < OmniAuth::Strategies::OAuth2
      option :name, 'lifelog_oauth2'

      option :client_options,
        {
          :site           => 'https://platform.lifelog.sonymobile.com',
          :authorize_url  => 'https://platform.lifelog.sonymobile.com/oauth/2/authorize',
